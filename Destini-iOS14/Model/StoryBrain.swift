...
struct StoryBrain {
    ...
    var storyPoint: Int = 0
    
    mutating func getNextStoryPoint(_ destination: Int) -> String {
        storyPoint = destination
        return story[destination].title
    }
    
    func getChoice1() -> String {
        return story[storyPoint].choice1
    }
    
    func getChoice2() -> String {
        return story[storyPoint].choice2
    }
    
    func getDestination1() -> Int {
        return story[storyPoint].choice1Destination
    }
    
    func getDestination2() -> Int {
        return story[storyPoint].choice2Destination
    }
}
